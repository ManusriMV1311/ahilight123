            ...
            {items.map((item, idx) => (
              ...
              >
                <a
                  href={item.href}
                  key={item.title}
                  className="flex items-center gap-4 rounded-full bg-gray-50 p-2 dark:bg-neutral-900"
                >
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-200 dark:bg-neutral-800">
