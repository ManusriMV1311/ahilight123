...
export function Hero() {
    ...
    return (
        <section className="relative min-h-[80vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-transparent antialiased pt-32 pb-8 md:pt-0 md:pb-0">
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="mb-8">
                        <TypewriterEffect
                            ...
                            className="text-3xl md:text-5xl lg:text-7xl font-bold text-center tracking-tight font-heading leading-relaxed md:leading-tight py-4"
